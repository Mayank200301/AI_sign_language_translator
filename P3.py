    ...
    if hands:
        if len(hands) == 2:
            ...
            if label == "Uncertain":
                ...
                text_color = (0, 0, 0)     # Black text on yellow box
            else:
            ...
            cv2.rectangle(imgOutput, (x - offset, y - offset - 50),
                          (x - offset + 90, y - offset - 50 + 50), box_color, cv2.FILLED)
            cv2.putText(imgOutput, label, (x, y - 26),
                        cv2.FONT_HERSHEY_COMPLEX, 1.7, text_color, 2)

            # Draw hand bounding box
            cv2.rectangle(imgOutput, (x - offset, y - offset),
                          (x + w + offset, y + h + offset), box_color, 4)


            cv2.putText(imgOutput, label, (50, 50), cv2.FONT_HERSHEY_SIMPLEX,2, (0, 255, 0), 2, cv2.LINE_AA)
